    ...
    <div class="">
        <div style="row">
            <div class="col d-flex justify-content-center" style="background-color:#7d7d7d;">
                <img src="{{ $order->buyer->foto }}" alt="" style="width: 40%">
            </div>
        </div>
        <div class="ms-5 me-5 mt-5">

            <h1 style="font-weight:700;font-size: 60px;"> {{ $order->buyer->name }}</h1>
            <div class="row mt-5">
                <div class="col-auto">
                    <i class='bx bxs-graduation' style="font-size: 40px;"></i> 
                </div>
                <div class="col d-flex align-items-center">
                    <p style="font-size: 25px;">Alumni {{  $order->buyer->instansi }}</p>
                </div>
            </div>
            <div class="row">
                <div class="col-auto">
                ...
                <div class="col d-flex align-items-center">
                    <p style="font-size: 25px;">{{ $order->buyer->keahlian->nama ?? '-' }}</p>
            </div>
            <div class="row">
                <div class="col-auto">
