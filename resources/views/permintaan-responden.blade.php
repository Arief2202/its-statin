            ...
            <a class="link-card" href="/permintaan-responden/{{$survey->id}}">
                <div class="card mt-5">
                    <div class="row ps-3 pt-3 pb-3">
                        ...
                        <div class="col">
                            <p style="font-weight:700; font-size:30px; margin:0em; padding:0em;">{{ $survey->buyer->name }}</p>
                            <p style="font-size:20px; margin:0em; padding:0em;">Keahlian {{ $survey->buyer->nama }}</p>
                            <p style="font-size:20px; margin:0em; padding:0em;">{{ $survey->buyer->instansi }}</p>
                            <div class="row mt-3">
                                <div class="col">
